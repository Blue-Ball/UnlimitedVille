...
<head>
    ...
    <meta name="csrf-token" content="qIjkGntRrcG152Esv93DF9Fz9LouS99WdnRojKLz">
    <meta name="stripe-key" content="">

    <!-- Page Metadata -->
    <title>Plan Lookup Request | Unlimitedville</title>
    <!-- Fonts -->
                ...
                <div>
                    <form>
                        ...
                        <div class="mt-4 text-center"><button type="submit" class="btn btn-primary">
                                <!----> Submit <span>&nbsp;<i class="fa-fw fas fa-angle-right"></i></span></button>
                        </div>
